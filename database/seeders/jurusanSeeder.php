...
class JurusanSeeder extends Seeder
{
    ...
    public function run()
    {
        $data_jurusan = [
            ...
            ['id_jurusan' => 'PPLG', 'nama_jurusan' => 'Pengembangan Perangkat Lunak dan Gim'],
            ['id_jurusan' => 'RPL', 'nama_jurusan' => 'Rekayasa Perangkat Lunak'],
            ['id_jurusan' => 'TJKT', 'nama_jurusan' => 'Teknik Jaringan Komputer Telekomunikasi'],
            ['id_jurusan' => 'TKJ', 'nama_jurusan' => 'Teknik Komputer Jaringan'],
        ];


        Jurusan::insert($data_jurusan);
