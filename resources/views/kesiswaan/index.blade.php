                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="#" class="menu-link">
                            ...
                            <div data-i18n="Basic">Laporan Kelas</div>
                        </a>
                    </li>
                                                ...
                                                <div class="progress" style="height: 30px">
                                                    @if ($persen == 0)
                                                        <div class="progress-bar bg-white w-100 text-dark"
                                                            aria-valuenow="100%" aria-valuemax="100%">0% Kehadiran</div>
                                                    @else
                                                        <div class="progress-bar bg-absen w-{{ $persen }}"
                                                            aria-valuenow="{{ $persen }}%" aria-valuemax="100%">
                                                ...
                                                <div class="col">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="progress" style="height: 30px">
                                                                @if ($persentase[$nama] == 0)
                                                                    <div class="progress-bar bg-white w-100 text-dark">
                                                                        {{ $persentase[$nama] }}% Kehadiran
                                                                    </div>
                                                                @else
                                                                    <div
                                                                        class="progress-bar bg-absen w-{{ $persentase[$nama] }}">
                                                                        {{ $persentase[$nama] }}% Kehadiran
                                                                    </div>
                                                                @endif
                                                            </div>
