        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col mb-3">
                    ...
                    <select name="id_jurusan" id="jurusan" class="form-select">
                        <option value= {{ $w->jurusan->id_jurusan}}> @php echo($w->jurusan->nama_jurusan); @endphp </option>
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <input name="nomor_kelas" id="nomor" class="form-control" value={{ $w->nomor_kelas}} placeholder="Masukkan Nomor Kelas">
                    </input>
                </div>
                <div class="col mb-3">
    ...
    @method('delete')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">Peringatan Data <i><b> @php echo($w->tingkat); echo(' '); echo($w->jurusan->nama_jurusan); echo(' '); echo($w->nomor_kelas); @endphp </b></i> Akan Dihapus Secara Permanen!</div>
            <div class="modal-footer">
