                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action= {{ route('editabsen') }}>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <label for="mulaiMasuk" class="col-form-label">Mulai Absen
                                                    Masuk</label>
                                            ...
                                            <div class="col">
                                                <label for="batasMasuk" class="col-form-label">Batas Absen
                                                    Masuk</label>
                                                <input class="form-control" type="time"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <label for="mulaiPulang" class="col-form-label">Mulai Absen
                                                    Pulang</label>
                                                <input class="form-control" type="time"
                                            ...
                                            <div class="col">
                                                <label for="batasPulang" class="col-form-label">Batas Absen
                                                    Pulang</label>
                                                <input class="form-control" type="time"
